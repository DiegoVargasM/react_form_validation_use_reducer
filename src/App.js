...
function App() {
  ...
  /* 1. definir objeto de estado inicial */
  const initialState = {
    firstName: "",
    lastName: "",
    email: "",
  ...
  /* 3. Aplicar el hook para inicializar el estado */
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            onChange={e =>
              /* Usar la funcion dispatch para actualizar el estado */
